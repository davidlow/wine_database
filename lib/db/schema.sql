...
-- hierarchy_group_id: proximity group for walk-order optimization (replaces position_x/y)
...
-- Locations in the same group are treated as close; proximity degrades by LCA depth.
